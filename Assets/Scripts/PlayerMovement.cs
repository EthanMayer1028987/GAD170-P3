...
public class PlayerMovement : MonoBehaviour
{
    ...
    // hello, Ethan here forking up the script
    ...
    private void Update()
    {
        ...
        if (allowedMovement && Input.GetButtonDown("Jump") && isGrounded)
        {
    ...
    public void AllowMovement(bool isMoveable)
    {
        allowedMovement = isMoveable;
    }
